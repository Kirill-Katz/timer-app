    ...
    <VirtualScroller class="max-h-[46vh] pb-8" :items="app.projects" :item-height="56" item-key="id" :overscan="8">
      <template #default="{ item: project }">
        ...
        >
          ...
          <div data-swipe-card class="project-swipe-card relative grid h-full touch-pan-y grid-cols-[auto_1fr_auto] items-center gap-2 rounded-lg bg-panel px-3 py-2 transition-transform duration-150 ease-out will-change-transform" @click="app.openProjectLogDetail(project.id)">
