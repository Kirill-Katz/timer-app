...
<template>
  <MobileBottomSheet :show="app.menuSheetOpen" z-class="z-[80]" @close="app.closeSheets">
    <div class="grid gap-2">
      ...
      <button class="btn-primary inline-flex min-h-12 items-center justify-start rounded-xl px-4 text-left font-normal" type="button" @click="app.closeSheets(); app.openCalendar()">Calendar</button>
